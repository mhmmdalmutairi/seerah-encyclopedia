...
(function () {
  ...
  const LABELS = {
    ...
    country: {
      ...
      BN: "بروناي", SG: "سنغافورة", PH: "الفلبين", TH: "تايلاند",
      VN: "فيتنام", KH: "كمبوديا", MM: "ميانمار", LK: "سريلانكا",
      TJ: "طاجيكستان", KG: "قيرغيزستان", TM: "تركمانستان", AZ: "أذربيجان",
      BR: "البرازيل", AR: "الأرجنتين", MX: "المكسيك", VE: "فنزويلا",
      CO: "كولومبيا", CL: "شيلي", PE: "بيرو", CU: "كوبا", NZ: "نيوزيلندا",
      ZW: "زمبابوي", ZA: "جنوب إفريقيا",
    ...
    round: {
      ...
      "08g": "الجولة 8-ز — إندونيسيا وماليزيا وبروناي",
      "08h": "الجولة 8-ح — آسيا الوسطى والصين",
      "08k": "الجولة 8-ك — جنوب شرق آسيا",
      "08l": "الجولة 8-ل — أمريكا اللاتينية",
      "08m": "الجولة 8-م — أستراليا ونيوزيلندا",
      "08y": "الجولة 8-ي — الأطفال والناشئة",
      "08t": "الجولة 8-ط — إذاعات، كراسي، موالد، إفتاء",
    },
  };
  ...
  const OPPORTUNITIES = [
    ...
    { id: "sahabiyat", title: "مؤسسة سيدات الصحابة", icon: "👩", feasibility: 5, impact: 4, cost: 400, priority: "🔥",
      desc: "كيان واحد فقط (بعد المراجعة) في «النساء في السيرة» رغم 700M مسلمة. مؤسسة متخصّصة (كرسي + مجلة + مؤتمرات + موسوعة).",
      audience: "700M مسلمة" },
    ...
    { id: "quran-sira", title: "مرصد القرآن للسيرة", icon: "📖", feasibility: 5, impact: 3, cost: 350, priority: "متوسطة",
      desc: "تقاطع التفسير-السيرة مفقود تقريباً (صفر كيان مصنَّف seerah_in_quran بعد المراجعة). مركز يحلّل الآيات السيراوية، يبني خرائط معرفية للترتيب الزماني.",
    ...
    { id: "vr-museum", title: "متحف مكة/المدينة الافتراضي 3D", icon: "🕋", feasibility: 2, impact: 5, cost: 2000, priority: "طويل الأمد",
      desc: "دراسات مكة والمدينة 3 كيانات فقط (بعد المراجعة). منصّة 3D/VR تُعيد بناء جغرافيا مكة والمدينة سنة 622م بطبقات تفاعلية.",
  ...
  const COUNTRY_COORDS = {
    ...
    KE:[37,1], ET:[40,9], ER:[39,15], DJ:[42.5,11.5], ML:[-4,17],
    BN:[114.5,4.5], SG:[103.8,1.3], PH:[123,12], TH:[100,15],
    VN:[108,16], KH:[105,12], MM:[96,21], LK:[80.8,7.9],
    TJ:[71,38], KG:[75,41], TM:[58,38], AZ:[47.5,40.3],
    BR:[-55,-10], AR:[-65,-35], MX:[-102,23], VE:[-66,8],
    CO:[-74,4], CL:[-71,-32], PE:[-75,-10], CU:[-79,22], NZ:[174,-41],
    ZW:[29,-19]
  };
  ...
  const COUNTRY_FLAGS = {
    ...
    KE:"🇰🇪",ET:"🇪🇹",ER:"🇪🇷",DJ:"🇩🇯",ML:"🇲🇱",
    BN:"🇧🇳",SG:"🇸🇬",PH:"🇵🇭",TH:"🇹🇭",VN:"🇻🇳",KH:"🇰🇭",MM:"🇲🇲",LK:"🇱🇰",
    TJ:"🇹🇯",KG:"🇰🇬",TM:"🇹🇲",AZ:"🇦🇿",
    BR:"🇧🇷",AR:"🇦🇷",MX:"🇲🇽",VE:"🇻🇪",CO:"🇨🇴",CL:"🇨🇱",PE:"🇵🇪",CU:"🇨🇺",NZ:"🇳🇿",
    ZW:"🇿🇼",
